...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    Logger.debug('[Migration] Running 20250903_update_achievements_table migration')
    ...
    try {
      ...
      if (!tableInfo.badgeImage) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'badgeImage', {
      ...
      if (!tableInfo.rarity) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'rarity', {
      ...
      if (!tableInfo.xpValue) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'xpValue', {
      ...
      if (!tableInfo.isSecret) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'isSecret', {
      ...
      if (!tableInfo.unlockMessage) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'unlockMessage', {
          type: Sequelize.STRING,
          allowNull: true
        }))
      }
      ...
      if (!tableInfo.targetUnit && !tableInfo.nameKey) {
        ...
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'targetUnit', {
          type: Sequelize.STRING,
          allowNull: false,
          defaultValue: 'units'
        }))
        
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'nameKey', {
          type: Sequelize.STRING,
          allowNull: true
        }))
        
        columnsToAdd.push(() => queryInterface.addColumn('achievements', 'descKey', {
          type: Sequelize.STRING,
          allowNull: true
        }))
      }
      ...
      Logger.debug('[Migration] 20250903_update_achievements_table migration completed successfully')
      return true
    } catch (error) {
      Logger.error('[Migration] Error in 20250903_update_achievements_table migration', error)
      throw error
    }
  },
  ...
  down: async (queryInterface, Sequelize) => {
    try {
      ...
      Logger.error('[Migration] Error reverting 20250903_update_achievements_table migration', error)
      throw error
    }
  }
}
